...
- **Smart Merging / Optimistic Concurrency Improvements aka "CDRT-lite" **:
    - New "smart merging" for `List`, `Map`, `String`, and `Flyweight` types using operation hints to resolve
      conflicts automatically when changes are commutative (e.g., concurrent appends or unique key inserts)
