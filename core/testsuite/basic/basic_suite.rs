use moor_core::compiler::codegen::compile;
use moor_core::db::inmemtransient::InMemTransientDatabase;
use moor_core::tasks::sessions::NoopClientSession;
use moor_core::tasks::vm_test_utils::call_verb;
use moor_core::textdump::load_db::textdump_load;
