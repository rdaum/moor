object NEW_PLAYER_LOG
  ...
  verb msg_summary_line (this none this) owner: BYTE_QUOTA_UTILS_WORKING flags: "rxd"
  ...
  verb is_usable_by (this none this) owner: BYTE_QUOTA_UTILS_WORKING flags: "rxd"
  ...
  verb expire_old_messages (none none none) owner: BYTE_QUOTA_UTILS_WORKING flags: "rxd"
