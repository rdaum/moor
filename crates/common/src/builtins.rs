...
fn mk_builtin_table() -> Vec<Builtin> {
    vec![
        ...
        mk_builtin("read", Q(0), Q(2), vec![Typed(TYPE_OBJ), Any], false),
        ...
        mk_builtin("function_info", Q(0), Q(1), vec![Typed(TYPE_STR)], false),
        mk_builtin("load_server_options", Q(0), Q(0), vec![], false),
        mk_builtin("value_bytes", Q(1), Q(1), vec![Any], false),
        mk_builtin("value_hash", Q(1), Q(1), vec![Any], false),
        mk_builtin("string_hash", Q(1), Q(1), vec![Typed(TYPE_STR)], false),
        mk_builtin("binary_hash", Q(1), Q(1), vec![Typed(TYPE_STR)], false),
        mk_builtin(
            "decode_binary",
            Q(1),
            Q(2),
        ...
        mk_builtin("object_bytes", Q(1), Q(1), vec![Typed(TYPE_OBJ)], false),
        ...
        mk_builtin("renumber", Q(1), Q(1), vec![Typed(TYPE_OBJ)], false),
        mk_builtin("reset_max_object", Q(0), Q(0), vec![], false),
        mk_builtin("memory_usage", Q(0), Q(0), vec![], false),
        mk_builtin("shutdown", Q(0), Q(1), vec![Typed(TYPE_STR)], true),
        mk_builtin("dump_database", Q(0), Q(0), vec![], false),
        ...
        mk_builtin("listen", Q(2), Q(3), vec![Typed(TYPE_OBJ), Any, Any], false),
        mk_builtin("unlisten", Q(1), Q(1), vec![Any], false),
        mk_builtin("listeners", Q(0), Q(0), vec![], false),
        mk_builtin(
