...
pub(crate) fn do_compile_cst(parse_cst: ParseCst, compile_options: CompileOptions) -> Result<Program, CompileError> {
...
pub fn compile_with_tree_sitter(program: &str, options: CompileOptions) -> Result<Program, CompileError> {
...
#[cfg(feature = "tree-sitter-parser")]
pub fn compile_with_tree_sitter_moot_compatible(program: &str, options: CompileOptions) -> Result<Program, CompileError> {
