...
/// Create an error from a PEST parsing error
fn create_pest_error(pest_error: &pest::error::Error<Rule>) -> CompileError {
    ...
    let (line, col) = match pest_error.line_col {
        ...
        pest::error::LineColLocation::Span((l1, c1), (_l2, _c2)) => (l1, c1),
    };
    ...
    CompileError::ParseError {
        ...
        message: format!("Parse error: {}", pest_error.variant),
    }
}
