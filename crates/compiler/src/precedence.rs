...
pub fn get_precedence(expr: &Expr) -> u8 {
    match expr {
        ...
        Expr::Binary(op, _, _) => match op {
            ...
            BinaryOp::Gt | BinaryOp::GtE | BinaryOp::Lt | BinaryOp::LtE | BinaryOp::In => Precedence::Relational.as_u8(),
        ...
        Expr::Prop { .. } | Expr::Verb { .. } | Expr::Range { .. } | Expr::ComprehendRange { .. } |
        Expr::ComprehendList { .. } | Expr::Index(_, _) | Expr::Value(_) | Expr::Error(_, _) |
        Expr::Id(_) | Expr::TypeConstant(_) | Expr::List(_) | Expr::Map(_) | Expr::Flyweight(..) |
        Expr::Pass { .. } | Expr::Call { .. } | Expr::Length | Expr::Decl { .. } |
        Expr::Return(_) | Expr::TryCatch { .. } | Expr::Lambda { .. } => Precedence::Primary.as_u8(),
    }
}
