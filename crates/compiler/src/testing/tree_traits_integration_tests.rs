...
mod tests {
    ...
    use crate::builders::ast_builder::ASTBuilder;
    #[cfg(feature = "tree-sitter-parser")]
    ...
    fn test_cross_tree_equivalence() {
        ...
        // Parse with CST
        {
            use crate::parsers::parse_cst::parse_program_cst;
        ...
        #[cfg(feature = "tree-sitter-parser")]
        {
            use crate::parsers::tree_sitter::parse_treesitter::parse_with_tree_sitter;
    ...
    fn test_custom_handler_registration() {
        ...
        let mut builder = ASTBuilder::<TestNode>::new(CompileOptions::default());
    ...
    fn test_error_handling() {
        ...
        let mut builder = ASTBuilder::<ErrorNode>::new(CompileOptions::default());
    ...
    fn test_common_node_types() {
        ...
        let mut builder = ASTBuilder::<MockNode>::new(CompileOptions::default());
