...
static getRootAsStoredRangeComprehend(bb:flatbuffers.ByteBuffer, obj?:StoredRangeComprehend):StoredRangeComprehend {
  return (obj || new StoredRangeComprehend()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsStoredRangeComprehend(bb:flatbuffers.ByteBuffer, obj?:StoredRangeComprehend):StoredRangeComprehend {
