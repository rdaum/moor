...
import { StoredVarNameUnion, unionToStoredVarNameUnion, unionListToStoredVarNameUnion } from '../moor-program/stored-var-name-union.js';
...
static createStoredVariable(builder:flatbuffers.Builder, id:number, scopeId:number, varNameType:StoredVarNameUnion, varNameOffset:flatbuffers.Offset):flatbuffers.Offset {
