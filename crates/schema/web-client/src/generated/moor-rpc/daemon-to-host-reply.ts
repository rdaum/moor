...
import { DaemonToHostReplyUnion, unionToDaemonToHostReplyUnion, unionListToDaemonToHostReplyUnion } from '../moor-rpc/daemon-to-host-reply-union.js';
...
static getSizePrefixedRootAsDaemonToHostReply(bb:flatbuffers.ByteBuffer, obj?:DaemonToHostReply):DaemonToHostReply {
...
static createDaemonToHostReply(builder:flatbuffers.Builder, replyType:DaemonToHostReplyUnion, replyOffset:flatbuffers.Offset):flatbuffers.Offset {
