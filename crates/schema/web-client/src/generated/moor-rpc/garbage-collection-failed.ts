...
static getRootAsGarbageCollectionFailed(bb:flatbuffers.ByteBuffer, obj?:GarbageCollectionFailed):GarbageCollectionFailed {
  return (obj || new GarbageCollectionFailed()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsGarbageCollectionFailed(bb:flatbuffers.ByteBuffer, obj?:GarbageCollectionFailed):GarbageCollectionFailed {
...
static createGarbageCollectionFailed(builder:flatbuffers.Builder, messageOffset:flatbuffers.Offset):flatbuffers.Offset {
