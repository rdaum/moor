...
export class HistoryRecallSinceSeconds {
    ...
    static getRootAsHistoryRecallSinceSeconds(
        bb: flatbuffers.ByteBuffer,
        obj?: HistoryRecallSinceSeconds,
    ): HistoryRecallSinceSeconds {
        return (obj || new HistoryRecallSinceSeconds()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }

    static getSizePrefixedRootAsHistoryRecallSinceSeconds(
        bb: flatbuffers.ByteBuffer,
        obj?: HistoryRecallSinceSeconds,
    ): HistoryRecallSinceSeconds {
    ...
    static createHistoryRecallSinceSeconds(
