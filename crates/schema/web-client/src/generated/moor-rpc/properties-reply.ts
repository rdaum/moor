...
properties(index: number, obj?:PropInfo):PropInfo|null {
  ...
  return offset ? (obj || new PropInfo()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
static createPropertiesReply(builder:flatbuffers.Builder, propertiesOffset:flatbuffers.Offset):flatbuffers.Offset {
