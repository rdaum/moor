...
export function unionToSchedulerErrorUnion(
  ...
  accessor: (obj:CommandExecutionError|CompilationError|CouldNotStartTask|GarbageCollectionFailed|InputRequestNotFound|ObjectResolutionFailed|PropertyRetrievalFailed|SchedulerNotResponding|TaskAbortedCancelled|TaskAbortedError|TaskAbortedException|TaskAbortedLimit|TaskNotFound|VerbProgramFailed|VerbRetrievalFailed) => CommandExecutionError|CompilationError|CouldNotStartTask|GarbageCollectionFailed|InputRequestNotFound|ObjectResolutionFailed|PropertyRetrievalFailed|SchedulerNotResponding|TaskAbortedCancelled|TaskAbortedError|TaskAbortedException|TaskAbortedLimit|TaskNotFound|VerbProgramFailed|VerbRetrievalFailed|null
): CommandExecutionError|CompilationError|CouldNotStartTask|GarbageCollectionFailed|InputRequestNotFound|ObjectResolutionFailed|PropertyRetrievalFailed|SchedulerNotResponding|TaskAbortedCancelled|TaskAbortedError|TaskAbortedException|TaskAbortedLimit|TaskNotFound|VerbProgramFailed|VerbRetrievalFailed|null {
...
export function unionListToSchedulerErrorUnion(
  type: SchedulerErrorUnion, 
  accessor: (index: number, obj:CommandExecutionError|CompilationError|CouldNotStartTask|GarbageCollectionFailed|InputRequestNotFound|ObjectResolutionFailed|PropertyRetrievalFailed|SchedulerNotResponding|TaskAbortedCancelled|TaskAbortedError|TaskAbortedException|TaskAbortedLimit|TaskNotFound|VerbProgramFailed|VerbRetrievalFailed) => CommandExecutionError|CompilationError|CouldNotStartTask|GarbageCollectionFailed|InputRequestNotFound|ObjectResolutionFailed|PropertyRetrievalFailed|SchedulerNotResponding|TaskAbortedCancelled|TaskAbortedError|TaskAbortedException|TaskAbortedLimit|TaskNotFound|VerbProgramFailed|VerbRetrievalFailed|null, 
  index: number
): CommandExecutionError|CompilationError|CouldNotStartTask|GarbageCollectionFailed|InputRequestNotFound|ObjectResolutionFailed|PropertyRetrievalFailed|SchedulerNotResponding|TaskAbortedCancelled|TaskAbortedError|TaskAbortedException|TaskAbortedLimit|TaskNotFound|VerbProgramFailed|VerbRetrievalFailed|null {
  switch(SchedulerErrorUnion[type]) {
    case 'NONE': return null; 
