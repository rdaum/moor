...
export function unionToVerbProgramResponseUnion(
  ...
  switch(VerbProgramResponseUnion[type]) {
    ...
    case 'VerbProgramSuccess': return accessor(new VerbProgramSuccess())! as VerbProgramSuccess;
    case 'VerbProgramFailure': return accessor(new VerbProgramFailure())! as VerbProgramFailure;
    default: return null;
  }
}
...
export function unionListToVerbProgramResponseUnion(
  type: VerbProgramResponseUnion, 
  accessor: (index: number, obj:VerbProgramFailure|VerbProgramSuccess) => VerbProgramFailure|VerbProgramSuccess|null, 
  index: number
): VerbProgramFailure|VerbProgramSuccess|null {
  switch(VerbProgramResponseUnion[type]) {
    case 'NONE': return null; 
    case 'VerbProgramSuccess': return accessor(index, new VerbProgramSuccess())! as VerbProgramSuccess;
    case 'VerbProgramFailure': return accessor(index, new VerbProgramFailure())! as VerbProgramFailure;
    default: return null;
  }
}
