...
import { WorkerErrorUnion, unionToWorkerErrorUnion, unionListToWorkerErrorUnion } from '../moor-rpc/worker-error-union.js';
...
static createWorkerError(builder:flatbuffers.Builder, errorType:WorkerErrorUnion, errorOffset:flatbuffers.Offset):flatbuffers.Offset {
