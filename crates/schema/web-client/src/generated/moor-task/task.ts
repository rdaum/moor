...
import { TaskStart } from "../moor-task/task-start.js";
...
export class Task {
    ...
    taskStart(obj?: TaskStart): TaskStart | null {
        const offset = this.bb!.__offset(this.bb_pos, 10);
        return offset ? (obj || new TaskStart()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
    }
    ...
    static addTaskStart(builder: flatbuffers.Builder, taskStartOffset: flatbuffers.Offset) {
        builder.addFieldOffset(3, taskStartOffset, 0);
    }
    ...
    static endTask(builder: flatbuffers.Builder): flatbuffers.Offset {
        ...
        builder.requiredField(offset, 10); // task_start
