...
pub use variant::{
    Var, Variant, v_arc_string, v_binary, v_bool, v_bool_int, v_empty_list, v_empty_map,
    v_empty_str, v_err, v_error, v_float, v_flyweight, v_int, v_list, v_list_iter, v_map,
    v_map_iter, v_none, v_nothing, v_obj, v_objid, v_str, v_string, v_sym,
};
