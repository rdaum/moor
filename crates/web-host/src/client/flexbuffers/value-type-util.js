...
export function isTypedVectorElement(value) {
    return value === ValueType.BOOL || value >= ValueType.INT && value <= ValueType.STRING;
}
export function isTypedVector(value) {
    return value === ValueType.VECTOR_BOOL || value >= ValueType.VECTOR_INT && value <= ValueType.VECTOR_STRING_DEPRECATED;
}
...
export function isAVector(value) {
    return isTypedVector(value) || isFixedTypedVector(value) || value === ValueType.VECTOR;
}
