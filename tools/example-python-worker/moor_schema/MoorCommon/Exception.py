...
def ExceptionStart(builder): builder.StartObject(3)
def Start(builder):
    return ExceptionStart(builder)
def ExceptionAddError(builder, error): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(error), 0)
def AddError(builder, error):
    return ExceptionAddError(builder, error)
def ExceptionAddStack(builder, stack): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(stack), 0)
...
def ExceptionAddBacktrace(builder, backtrace): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(backtrace), 0)
def AddBacktrace(builder, backtrace):
    return ExceptionAddBacktrace(builder, backtrace)
def ExceptionStartBacktraceVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def StartBacktraceVector(builder, numElems):
