...
def OutOfBandStart(builder):
    builder.StartObject(4)

def Start(builder):
    OutOfBandStart(builder)

def OutOfBandAddClientToken(builder, clientToken):
...
def AddClientToken(builder, clientToken):
    OutOfBandAddClientToken(builder, clientToken)

def OutOfBandAddAuthToken(builder, authToken):
...
def AddAuthToken(builder, authToken):
    OutOfBandAddAuthToken(builder, authToken)

def OutOfBandAddHandlerObject(builder, handlerObject):
...
def AddHandlerObject(builder, handlerObject):
    OutOfBandAddHandlerObject(builder, handlerObject)

def OutOfBandAddCommand(builder, command):
...
def AddCommand(builder, command):
    OutOfBandAddCommand(builder, command)

def OutOfBandEnd(builder):
