...
def RetrieveStart(builder):
    builder.StartObject(5)

def Start(builder):
    RetrieveStart(builder)

def RetrieveAddClientToken(builder, clientToken):
...
def AddClientToken(builder, clientToken):
    RetrieveAddClientToken(builder, clientToken)

def RetrieveAddAuthToken(builder, authToken):
...
def AddAuthToken(builder, authToken):
    RetrieveAddAuthToken(builder, authToken)

def RetrieveAddObject(builder, object):
...
def AddObject(builder, object):
    RetrieveAddObject(builder, object)

def RetrieveAddEntityType(builder, entityType):
    builder.PrependUint8Slot(3, entityType, 0)

def AddEntityType(builder, entityType):
    RetrieveAddEntityType(builder, entityType)

def RetrieveAddName(builder, name):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)

def AddName(builder, name):
    RetrieveAddName(builder, name)

def RetrieveEnd(builder):
