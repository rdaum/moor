!function(A, I) {
    ...
    return (() => {
            ...
            g = {
                773: (A, I, g) => {
                    ...
                    E = "object" == typeof window,
                        ...
                        o = "object" == typeof process && "object" == typeof process.versions
                    ...
                    o
                        ...
                        : D
                        ? ("undefined" != typeof read && (n = function(A) {
                            return read(A);
                        }),
                            a = function(A) {
                                var I;
                    ...
                    function b(A) {
                        for (; A.length > 0;) {
                            ...
                            if ("function" != typeof I) {
                                var g = I.func;
                                "number" == typeof g
                                    ? void 0 === I.arg ? M.get(g)() : M.get(g)(I.arg)
                    ...
                    if (
                        Q.allocate = function(A, I) {
                            var g;
                            return g = 1 == I ? T(A.length) : W(A.length),
                ...
                631: function(A, I, g) {
                    ...
                    "undefined" != typeof self && self,
                        void 0 === (Q = "function" == typeof (B = function() {
                                    ...
                                    function B(I) {
                                        ...
                                        let C;
                                        return C = A.process && A.process.versions && A.process.versions.node
                                            ? Q().then(A =>
                                                new Promise(I => {
                                                    A.postRun = () => I(A);
                                                })
                                    ...
                                    return {
                                        ...
                                        unloadRuntime: function() {
                                            B._module
                                                && (B._module.unloadRuntime(), delete B._promise, delete B._module);
                                        },
                                    };
                                })
                                ? B.apply(I, [])
        ...
        return I = Object.getPrototypeOf ? A => Object.getPrototypeOf(A) : A => A.__proto__,
            Q.t = function(g, B) {
