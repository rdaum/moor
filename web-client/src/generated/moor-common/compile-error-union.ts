...
export function unionToCompileErrorUnion(
  ...
  accessor: (obj:AssignToConst|BadSlotName|DisabledFeature|DuplicateVariable|InvalidAssignment|ParseError|StringLexError|UnknownBuiltinFunction|UnknownLoopLabel|UnknownTypeConstant) => AssignToConst|BadSlotName|DisabledFeature|DuplicateVariable|InvalidAssignment|ParseError|StringLexError|UnknownBuiltinFunction|UnknownLoopLabel|UnknownTypeConstant|null
): AssignToConst|BadSlotName|DisabledFeature|DuplicateVariable|InvalidAssignment|ParseError|StringLexError|UnknownBuiltinFunction|UnknownLoopLabel|UnknownTypeConstant|null {
