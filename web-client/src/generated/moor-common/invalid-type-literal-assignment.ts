...
export class InvalidTypeLiteralAssignment {
    ...
    static getRootAsInvalidTypeLiteralAssignment(
        bb: flatbuffers.ByteBuffer,
        obj?: InvalidTypeLiteralAssignment,
    ): InvalidTypeLiteralAssignment {
        return (obj || new InvalidTypeLiteralAssignment()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }

    static getSizePrefixedRootAsInvalidTypeLiteralAssignment(
        bb: flatbuffers.ByteBuffer,
        obj?: InvalidTypeLiteralAssignment,
    ): InvalidTypeLiteralAssignment {
    ...
    static createInvalidTypeLiteralAssignment(
        builder: flatbuffers.Builder,
        contextOffset: flatbuffers.Offset,
        literalOffset: flatbuffers.Offset,
    ): flatbuffers.Offset {
