...
static getSizePrefixedRootAsPlayerPresentations(bb:flatbuffers.ByteBuffer, obj?:PlayerPresentations):PlayerPresentations {
...
presentations(index: number, obj?:StoredPresentation):StoredPresentation|null {
  ...
  return offset ? (obj || new StoredPresentation()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
static createPlayerPresentations(builder:flatbuffers.Builder, playerOffset:flatbuffers.Offset, presentationsOffset:flatbuffers.Offset):flatbuffers.Offset {
