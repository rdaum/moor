...
static getRootAsStoredForRangeOperand(bb:flatbuffers.ByteBuffer, obj?:StoredForRangeOperand):StoredForRangeOperand {
  return (obj || new StoredForRangeOperand()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsStoredForRangeOperand(bb:flatbuffers.ByteBuffer, obj?:StoredForRangeOperand):StoredForRangeOperand {
...
static createStoredForRangeOperand(builder:flatbuffers.Builder, loopVariableOffset:flatbuffers.Offset, endLabel:number, environmentWidth:number):flatbuffers.Offset {
