...
static getSizePrefixedRootAsStoredScatterArgs(bb:flatbuffers.ByteBuffer, obj?:StoredScatterArgs):StoredScatterArgs {
...
labels(index: number, obj?:StoredScatterLabel):StoredScatterLabel|null {
  ...
  return offset ? (obj || new StoredScatterLabel()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
static createStoredScatterArgs(builder:flatbuffers.Builder, labelsOffset:flatbuffers.Offset, done:number):flatbuffers.Offset {
