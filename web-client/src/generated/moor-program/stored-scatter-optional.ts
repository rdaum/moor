...
static getRootAsStoredScatterOptional(bb:flatbuffers.ByteBuffer, obj?:StoredScatterOptional):StoredScatterOptional {
  return (obj || new StoredScatterOptional()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsStoredScatterOptional(bb:flatbuffers.ByteBuffer, obj?:StoredScatterOptional):StoredScatterOptional {
...
static createStoredScatterOptional(builder:flatbuffers.Builder, nameOffset:flatbuffers.Offset, defaultLabel:number, hasDefault:boolean):flatbuffers.Offset {
