...
import { StoredNamedVar } from "../moor-program/stored-named-var";
import { StoredRegisterVar } from "../moor-program/stored-register-var";
...
export function unionToStoredVarNameUnion(
    ...
    switch (StoredVarNameUnion[type]) {
        case "NONE":
            return null;
        case "StoredNamedVar":
            return accessor(new StoredNamedVar())! as StoredNamedVar;
        case "StoredRegisterVar":
            return accessor(new StoredRegisterVar())! as StoredRegisterVar;
        default:
            return null;
    }
}
...
export function unionListToStoredVarNameUnion(
    ...
    switch (StoredVarNameUnion[type]) {
        case "NONE":
            return null;
        case "StoredNamedVar":
            return accessor(index, new StoredNamedVar())! as StoredNamedVar;
        case "StoredRegisterVar":
            return accessor(index, new StoredRegisterVar())! as StoredRegisterVar;
        default:
            return null;
    }
}
