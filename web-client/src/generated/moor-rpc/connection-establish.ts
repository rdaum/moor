...
static getSizePrefixedRootAsConnectionEstablish(bb:flatbuffers.ByteBuffer, obj?:ConnectionEstablish):ConnectionEstablish {
...
connectionAttributes(index: number, obj?:ConnectionAttribute):ConnectionAttribute|null {
  ...
  return offset ? (obj || new ConnectionAttribute()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
static createConnectionAttributesVector(builder:flatbuffers.Builder, data:flatbuffers.Offset[]):flatbuffers.Offset {
  builder.startVector(4, data.length, 4);
  for (let i = data.length - 1; i >= 0; i--) {
    builder.addOffset(data[i]!);
  }
...
static createConnectionEstablish(builder:flatbuffers.Builder, peerAddrOffset:flatbuffers.Offset, localPort:number, remotePort:number, acceptableContentTypesOffset:flatbuffers.Offset, connectionAttributesOffset:flatbuffers.Offset):flatbuffers.Offset {
