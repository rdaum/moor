...
export function unionToDaemonToClientReplyUnion(
  ...
  accessor: (obj:AttachResult|ClientAttributeSet|CurrentPresentations|Disconnected|EvalResult|EventLogHistoryDeleted|EventLogPublicKey|HistoryResponseReply|InputThanks|ListObjectsReply|LoginResult|NewConnection|PresentationDismissed|PropertiesReply|PropertyUpdated|PropertyValue|ResolveResult|SysPropValue|TaskSubmitted|ThanksPong|VerbProgramResponseReply|VerbValue|VerbsReply) => AttachResult|ClientAttributeSet|CurrentPresentations|Disconnected|EvalResult|EventLogHistoryDeleted|EventLogPublicKey|HistoryResponseReply|InputThanks|ListObjectsReply|LoginResult|NewConnection|PresentationDismissed|PropertiesReply|PropertyUpdated|PropertyValue|ResolveResult|SysPropValue|TaskSubmitted|ThanksPong|VerbProgramResponseReply|VerbValue|VerbsReply|null
