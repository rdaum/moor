...
import { DaemonToHostAck } from "../moor-rpc/daemon-to-host-ack";
import { DaemonToHostPerfCounters } from "../moor-rpc/daemon-to-host-perf-counters";
import { DaemonToHostReject } from "../moor-rpc/daemon-to-host-reject";
import { ServerFeatures } from "../moor-rpc/server-features";
...
export function unionToDaemonToHostReplyUnion(
    ...
    accessor: (
        obj: DaemonToHostAck | DaemonToHostPerfCounters | DaemonToHostReject | ServerFeatures,
    ...
    switch (DaemonToHostReplyUnion[type]) {
        ...
        case "ServerFeatures":
            return accessor(new ServerFeatures())! as ServerFeatures;
        default:
            return null;
    }
}
...
export function unionListToDaemonToHostReplyUnion(
    ...
    switch (DaemonToHostReplyUnion[type]) {
        ...
        case "ServerFeatures":
            return accessor(index, new ServerFeatures())! as ServerFeatures;
        default:
            return null;
    }
}
