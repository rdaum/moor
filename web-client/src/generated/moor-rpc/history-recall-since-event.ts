...
static getRootAsHistoryRecallSinceEvent(bb:flatbuffers.ByteBuffer, obj?:HistoryRecallSinceEvent):HistoryRecallSinceEvent {
  return (obj || new HistoryRecallSinceEvent()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsHistoryRecallSinceEvent(bb:flatbuffers.ByteBuffer, obj?:HistoryRecallSinceEvent):HistoryRecallSinceEvent {
...
static createHistoryRecallSinceEvent(builder:flatbuffers.Builder, eventIdOffset:flatbuffers.Offset, limit:bigint):flatbuffers.Offset {
