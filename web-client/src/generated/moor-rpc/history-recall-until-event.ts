...
export class HistoryRecallUntilEvent {
    ...
    static getRootAsHistoryRecallUntilEvent(
        bb: flatbuffers.ByteBuffer,
        obj?: HistoryRecallUntilEvent,
    ): HistoryRecallUntilEvent {
        return (obj || new HistoryRecallUntilEvent()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }

    static getSizePrefixedRootAsHistoryRecallUntilEvent(
        bb: flatbuffers.ByteBuffer,
        obj?: HistoryRecallUntilEvent,
    ): HistoryRecallUntilEvent {
    ...
    static createHistoryRecallUntilEvent(
