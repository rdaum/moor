...
import { HistoryRecallUnion, unionToHistoryRecallUnion, unionListToHistoryRecallUnion } from '../moor-rpc/history-recall-union.js';
...
static createHistoryRecall(builder:flatbuffers.Builder, recallType:HistoryRecallUnion, recallOffset:flatbuffers.Offset):flatbuffers.Offset {
