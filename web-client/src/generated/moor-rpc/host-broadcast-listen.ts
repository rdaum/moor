...
static getSizePrefixedRootAsHostBroadcastListen(bb:flatbuffers.ByteBuffer, obj?:HostBroadcastListen):HostBroadcastListen {
...
static createHostBroadcastListen(builder:flatbuffers.Builder, handlerObjectOffset:flatbuffers.Offset, hostType:HostType, port:number, printMessages:boolean):flatbuffers.Offset {
