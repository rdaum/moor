...
static getRootAsHostBroadcastUnlisten(bb:flatbuffers.ByteBuffer, obj?:HostBroadcastUnlisten):HostBroadcastUnlisten {
  return (obj || new HostBroadcastUnlisten()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsHostBroadcastUnlisten(bb:flatbuffers.ByteBuffer, obj?:HostBroadcastUnlisten):HostBroadcastUnlisten {
...
static createHostBroadcastUnlisten(builder:flatbuffers.Builder, hostType:HostType, port:number):flatbuffers.Offset {
