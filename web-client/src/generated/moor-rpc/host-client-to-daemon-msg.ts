...
static getRootAsHostClientToDaemonMsg(bb:flatbuffers.ByteBuffer, obj?:HostClientToDaemonMsg):HostClientToDaemonMsg {
  return (obj || new HostClientToDaemonMsg()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsHostClientToDaemonMsg(bb:flatbuffers.ByteBuffer, obj?:HostClientToDaemonMsg):HostClientToDaemonMsg {
...
message(obj?:HostClientToDaemonMessage):HostClientToDaemonMessage|null {
  ...
  return offset ? (obj || new HostClientToDaemonMessage()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}
