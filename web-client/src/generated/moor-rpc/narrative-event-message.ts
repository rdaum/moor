...
static getRootAsNarrativeEventMessage(bb:flatbuffers.ByteBuffer, obj?:NarrativeEventMessage):NarrativeEventMessage {
  return (obj || new NarrativeEventMessage()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsNarrativeEventMessage(bb:flatbuffers.ByteBuffer, obj?:NarrativeEventMessage):NarrativeEventMessage {
...
event(obj?:NarrativeEvent):NarrativeEvent|null {
  ...
  return offset ? (obj || new NarrativeEvent()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}
