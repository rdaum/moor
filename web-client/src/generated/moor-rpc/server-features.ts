...
static createServerFeatures(builder:flatbuffers.Builder, persistentTasks:boolean, richNotify:boolean, lexicalScopes:boolean, typeDispatch:boolean, flyweightType:boolean, listComprehensions:boolean, boolType:boolean, useBooleanReturns:boolean, symbolType:boolean, useSymbolsInBuiltins:boolean, customErrors:boolean, useUuobjids:boolean, enableEventlog:boolean, anonymousObjects:boolean):flatbuffers.Offset {
