...
static getRootAsTaskAbortedVerbNotFound(bb:flatbuffers.ByteBuffer, obj?:TaskAbortedVerbNotFound):TaskAbortedVerbNotFound {
  return (obj || new TaskAbortedVerbNotFound()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTaskAbortedVerbNotFound(bb:flatbuffers.ByteBuffer, obj?:TaskAbortedVerbNotFound):TaskAbortedVerbNotFound {
