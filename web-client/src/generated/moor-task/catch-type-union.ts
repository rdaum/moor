...
import { CatchAny } from "../moor-task/catch-any";
import { CatchErrors } from "../moor-task/catch-errors";
...
export function unionToCatchTypeUnion(
    ...
    switch (CatchTypeUnion[type]) {
        case "NONE":
            return null;
        case "CatchAny":
            return accessor(new CatchAny())! as CatchAny;
        case "CatchErrors":
            return accessor(new CatchErrors())! as CatchErrors;
        default:
            return null;
    }
}
...
export function unionListToCatchTypeUnion(
    ...
    switch (CatchTypeUnion[type]) {
        case "NONE":
            return null;
        case "CatchAny":
            return accessor(index, new CatchAny())! as CatchAny;
        case "CatchErrors":
            return accessor(index, new CatchErrors())! as CatchErrors;
        default:
            return null;
    }
}
