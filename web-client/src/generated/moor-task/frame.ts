...
import { FrameUnion, unionToFrameUnion, unionListToFrameUnion } from '../moor-task/frame-union.js';
...
static createFrame(builder:flatbuffers.Builder, frameType:FrameUnion, frameOffset:flatbuffers.Offset):flatbuffers.Offset {
