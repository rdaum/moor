...
environment(index: number, obj?:EnvironmentScope):EnvironmentScope|null {
  ...
  return offset ? (obj || new EnvironmentScope()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
scopeStack(index: number, obj?:Scope):Scope|null {
  ...
  return offset ? (obj || new Scope()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
finallyStack(index: number, obj?:FinallyReason):FinallyReason|null {
  ...
  return offset ? (obj || new FinallyReason()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
captureStack(index: number, obj?:CapturedVar):CapturedVar|null {
  ...
  return offset ? (obj || new CapturedVar()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
