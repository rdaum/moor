...
import { action_invoke, handleUserClosePresentation, htmlPurifySetup, Narrative } from "./narrative";
...
// Export to global module object for djot generated links
(window as any).module.action_invoke = action_invoke;
(window as any).module.context = context;
